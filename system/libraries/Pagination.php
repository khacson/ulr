...
class CI_Pagination {
	...
	var $full_tag_open		= '';
	var $full_tag_close		= '';
	var $first_tag_open		= '<div class="button2-right" title="First page"><div class="start">';
	var $first_tag_close            = '</div></div>';
	var $last_tag_open		= '<div class="button2-left" title="Last page"><div class="end">';
	var $last_tag_close		= '</div></div>';
	var $cur_tag_open		= '<span>';
	var $cur_tag_close		= '</span>';
	var $next_tag_open		= '<div class="button2-left" title="Next page"><div class="next">';
	var $next_tag_close		= '</div></div>';
	var $prev_tag_open		= '<div class="button2-right" title="Previous page"><div class="prev">';
	...
	function create_links($cur_page=0)
	{
		...
		for ($loop = $start -1; $loop <= $end; $loop++)
		{
			...
			if ($i >= 0)
			{
				...
				{
					$output .= $this->num_tag_open.'<a href="javascript:void(0);" title="Trang '.$loop.'" name="'.$i.'">'.$loop.'</a>'.$this->num_tag_close;
				}
			}
		}
