            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="form-group">
                        <label class="control-label col-md-4">Tên danh mục (<span class="red">*</span>)</label>
                        <div class="col-md-8">
...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption" style="margin-top:4px;">
            <i>Có <span class='viewtotal'>0</span> Tên danh mục</i>
        </div>
        <div class="tools">
                    ...
                    <div id="tHeader">    	
                        <table id="tbheader" width="100%" cellspacing="0" border="1" >
                            ...
                            <tr>
                                ...
                                <th>STT</th>
                                <th id="ord_catalog_name">Tên danh mục</th>
                                <th>Hình ảnh</th>
...
<script>
    ...
    $(function() {
        ...
        $('#edit').click(function() {
            var id = $('#id').val();
            if (id == '') {
                warning('Vui lòng chọn Tên danh mục để sửa');
                return false;
            }
            save('edit', id);
        });
        $('#delete').click(function() {
            $.msgBox({
                title: 'Message',
                type: 'error',
                content: 'Bạn muốn xóa Tên danh mục?',
    ...
    function save(func, id) {
        ...
        if (obj.catalog_name == '') {
            error("Tên danh mục <?= getLanguage('all', 'empty') ?>");
            return false;
        }
        $('.loading').show();
