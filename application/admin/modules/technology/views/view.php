...
<script>
    ...
    $(function() {
        ...
        $('#save').click(function() {
            //save('save', '');
			var id = $('#id').val();
            location.href = '<?=base_url()."admin.php/technology/form"?>';
        });
        $('#edit').click(function() {
            var id = $('#id').val();
            if (id == '') {
            ...
            //save('edit', id);			
            location.href = '<?=base_url()."admin.php/technology/edits/"?>'+id;
        });
    ...
    function funcList(obj) {
        $('.edit').each(function(e) {
            $(this).click(function() {
                ...
                var technologytypeid = $(this).attr('technologytypeid');
                $('#title').val(title);
				$('#technologytypeid').multipleSelect('setSelects',[technologytypeid]);
            });
        });
    ...
    function refresh() {
        ...
        $('.searchs').val('');
        $('#show').html('');
		$('#technologytypeid').multipleSelect('uncheckAll');
