            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="form-group">
                        <label class="control-label col-md-3">Loại tin tức (<span class="red">*</span>)</label>
                        <div class="col-md-9">
                            <input type="text" name="blogtype_name" id="blogtype_name" class="searchs form-control" />
                        </div>
                    </div>
                </div>
				<div class="col-md-4">
...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption" style="margin-top:4px;">
            <i>Có <span class='viewtotal'>0</span> loại tin tức</i>
        </div>
        <div class="tools">
                    ...
                    <div id="tHeader">    	
                        <table id="tbheader" width="100%" cellspacing="0" border="1" >
                            ...
                            <tr>
                                ...
                                <th>STT</th>
                                <th id="ord_blogtype_name">Loại tin tức</th>
                                <th>Hình ảnh</th>
...
<script>
    ...
    $(function() {
        ...
        $('#edit').click(function() {
            var id = $('#id').val();
            if (id == '') {
                warning('Vui lòng chọn loại tin tức để sửa');
                return false;
            }
            save('edit', id);
        });
        $('#delete').click(function() {
            $.msgBox({
                title: 'Message',
                type: 'error',
                content: 'Bạn muốn xóa Loại tin tức?',
    ...
    function save(func, id) {
        ...
        if (obj.blogtype_name == '') {
            error("Loại tin tức <?= getLanguage('all', 'empty') ?>");
            return false;
        }
        $('.loading').show();
    ...
    function funcList(obj) {
        $('.edit').each(function(e) {
            $(this).click(function() {
                var blogtype_name = $('.blogtype_name').eq(e).html().trim();
                var id = $(this).attr('id');
				var parentid = $(this).attr('parentid');
                $('#id').val(id);
                $('#blogtype_name').val(blogtype_name);
