            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="form-group">
                        <label class="control-label col-md-4">Tỉnh thành phố (<span class="red">*</span>)</label>
                        <div class="col-md-8">
...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption" style="margin-top:4px;">
            <i>Có <span class='viewtotal'>0</span> Tên tỉnh thành phố</i>
        </div>
        <div class="tools">
                    ...
                    <div id="tHeader">    	
                        <table id="tbheader" width="100%" cellspacing="0" border="1" >
                            ...
                            <tr>
                                ...
                                <th>STT</th>
                                <th id="ord_province_name">Tên tỉnh thành phố</th>
                                <th>Hình ảnh</th>
...
<script>
    ...
    $(function() {
        ...
        $('#edit').click(function() {
            var id = $('#id').val();
            if (id == '') {
                warning('Vui lòng chọn Tên tỉnh thành phố để sửa');
                return false;
            }
            save('edit', id);
        });
        $('#delete').click(function() {
            $.msgBox({
                title: 'Message',
                type: 'error',
                content: 'Bạn muốn xóa Tên tỉnh thành phố?',
    ...
    function save(func, id) {
        ...
        if (obj.province_name == '') {
            error("Tên tỉnh thành phố <?= getLanguage('all', 'empty') ?>");
            return false;
        }
        $('.loading').show();
