...
class Province extends CI_Controller {
    ...
    function save() {
        ...
        $login = $this->login;
        $array['friendlyurl'] = $this->admin->friendlyURL($array['province_name']);
    ...
    function deletes() {
        ...
        $array['isdelete'] = 1;
        $this->model->table('vland_province')->where('id',$id)->delete();
    ...
    function isHome(){
		...
		$this->model->table('vland_province')->save($id,$array);	
	}
	function ordering(){
		$array = array();
		$id = $this->input->post('id');
