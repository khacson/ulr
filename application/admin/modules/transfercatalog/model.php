<?php
 class TransfercatalogModel extends CI_Model{
	...
	function saves($array){
		 $check = $this->model->table('vland_transfer_catalog')
		 ->select('id')
		 ->where('isdelete',0)
	...
	function edits($array,$id){
		 ...
		 $result = $this->model->table('vland_transfer_catalog')->save($id,$array);	
		 return $result;
	}
