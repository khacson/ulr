 ...
 * @copyright 2015
 */
class Transfercatalog extends CI_Controller {
    ...
    function deletes() {
        ...
        $array['isdelete'] = 1;
        $this->model->table('vland_transfer_catalog')->where('id',$id)->delete();
    ...
    function isHome(){
		...
		$this->model->table('vland_transfer_catalog')->save($id,$array);	
	}
	function ordering(){
		$array = array();
		$id = $this->input->post('id');
