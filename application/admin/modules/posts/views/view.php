					...
					<div class="form-group">
						...
						<div class="col-md-8" >
							<select name="typeid" id="typeid" class="combos" >
								<option value=""></option>
								<?php foreach ($postsTypes as $item) { ?>
									<option value="<?=$item->id;?>"><?=$item->poststype_name?></option>
								<?php } ?>
							</select>
						</div>
					</div>
...
<script>
    ...
    $(function() {
        ...
        $('#save').click(function() {
            //save('save', '');
			var id = $('#id').val();
            location.href = '<?=base_url()."admin.php/posts/form"?>';
        });
        $('#edit').click(function() {
            var id = $('#id').val();
            if (id == '') {
            ...
            //save('edit', id);			
            location.href = '<?=base_url()."admin.php/posts/edits/"?>'+id;
        });
