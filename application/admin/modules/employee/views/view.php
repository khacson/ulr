...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption" style="margin-top:4px;">
            <i>Có <span class='viewtotal'>0</span> nhân viên tư vấn</i>
        </div>
        <div class="tools">
                    ...
                    <div id="tHeader">    	
                        <table id="tbheader" width="100%" cellspacing="0" border="1" >
                            ...
                            <tr>
                                ...
                                <th>STT</th>
                                <th id="ord_e.title">Họ tên</th>
								<th id="ord_e.position">Chức vụ</th>
								<th id="ord_e.phone">Điện thoại</th>
								<th id="ord_e.email">Email</th>
								<th id="ord_e.zalo">Zalo</th>
								<th id="ord_e.skype">Skype</th>
								<th id="ord_e.facebook">Facebook</th>
								<th id="ord_e.google">Google</th>
                                <th >Hình ảnh</th>
								<th >Vị trí</th>
                                <th></th>
                            </tr>
...
<script>
    ...
    $(function() {
        ...
        $('#save').click(function() {
            //save('save', '');
			var id = $('#id').val();
            location.href = '<?=base_url()."admin.php/employee/form"?>';
        });
        $('#edit').click(function() {
            var id = $('#id').val();
            if (id == '') {
            ...
            //save('edit', id);			
            location.href = '<?=base_url()."admin.php/employee/edits/"?>'+id;
        });
