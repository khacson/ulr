    ...
    <div class="portlet box blue">
        ...
        <div class="portlet-body">
			...
			<div class="row mtop10"> 
				<div class="col-md-4">
					<div class="form-group">
						<label class="control-label col-md-4">Khu vực (<span class="red">*</span>) </label>
						<div class="col-md-8" >
							<select name="producttypeid" id="producttypeid" class="combos" >
								<option value=""></option>
				...
				<div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="col-md-6" >
                                <span id="show2">
									<img src="<?=base_url();?>files/product/thumb/<?=$finds->thumb; ?>" style="width:60px; height:40px; " />
								</span> 
                            </div>
                        </div>
                    </div>
							...
							<div class="col-md-9" >
								 <div class="row">
									 <span id="show_car_images">
										...
										?>
											<div class="oneimg newimg" name="<?=$v; ?>"><img height="40" width="50" src="<?=base_url();?>files/product/<?=$v; ?>" class="imgupload" /><div class="rmoneimg"><i class="fa fa-times" aria-hidden="true"></i></div></div>
										<?php }?>
									 </span> 
								 </div>
							</div>
...
<script>
    ...
    function save(func, id, type) {
        search = getSearch();
		var producttypeid = getCombo('producttypeid');
        var token = $('#token').val();
