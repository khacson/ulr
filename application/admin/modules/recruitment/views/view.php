...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption"  style="margin-top:4px;">
            <i>Có <span class='viewtotal'>0</span> tuyển dụng</i>
        </div>
        <div class="tools">
...
<script>
    ...
    $(function() {
        ...
        $('#save').click(function() {
            //save('save', '');
			var id = $('#id').val();
            location.href = '<?=base_url()."admin.php/recruitment/form"?>';
        });
        $('#edit').click(function() {
            var id = $('#id').val();
            if (id == '') {
            ...
            //save('edit', id);			
            location.href = '<?=base_url()."admin.php/recruitment/edits/"?>'+id;
        });
        $('#delete').click(function(){
            ...
            $.msgBox({
                title: 'Message',
                type: 'error',
                content: 'Bạn muốn xóa tuyển dụng?',
    ...
    function funcList(obj) {
        $('.edit').each(function(e) {
            $(this).click(function() {
                ...
                var recruitmenttypeid = $(this).attr('recruitmenttypeid');
                $('#title').val(title);
				$('#recruitmenttypeid').multipleSelect('setSelects',[recruitmenttypeid]);
    ...
    function refresh() {
        ...
        $('.searchs').val('');
        $('#show').html('');
		$('#recruitmenttypeid').multipleSelect('uncheckAll');
