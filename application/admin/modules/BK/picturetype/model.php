<?php
 class PicturetypeModel extends CI_Model{
	...
	function saves($array){
		 $check = $this->model->table('mec_picturetype')
		 ->select('id')
		 ->where('isdelete',0)
	...
	function edits($array,$id){
		 ...
		 unset($array['fromdate']);
                 unset($array['todate']);
		 $result = $this->model->table('mec_picturetype')->save($id,$array);	
		 return $result;
	}
