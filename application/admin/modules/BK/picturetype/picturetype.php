 ...
 * @copyright 2015
 */
class Picturetype extends CI_Controller {
    ...
    function save() {
        ...
        $login = $this->login;
        $array['friendlyurl'] = $this->admin->friendlyURL($array['picturetype_name']);
    ...
    function deletes() {
        ...
        $array['isdelete'] = 1;
        $this->model->table('mec_picturetype')->where('id',$id)->delete();
    ...
    function isHome(){
		...
		$this->model->table('mec_picturetype')->save($id,$array);	
	}
	function ordering(){
		$array = array();
		$id = $this->input->post('id');
