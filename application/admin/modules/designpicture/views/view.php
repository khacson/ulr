...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption" style="margin-top:4px;">
            <i>Có <span class='viewtotal'>0</span> hình ảnh/video</i>
        </div>
        <div class="tools">
...
<script>
    ...
    $(function() {
        ...
        $('#save').click(function() {
            //save('save', '');
			var id = $('#id').val();
            location.href = '<?=base_url()."admin.php/designpicture/form"?>';
        });
        $('#edit').click(function() {
            var id = $('#id').val();
            if (id == '') {
            ...
            //save('edit', id);			
            location.href = '<?=base_url()."admin.php/designpicture/edits/"?>'+id;
        });
