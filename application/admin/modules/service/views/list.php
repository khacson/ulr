...
?>
	...
	<tr class="content edit" img = "<?=$item->thumb;?>" 
		...
		<td class="text-right"><?=number_format($item->price); ?> <?=$price_type;?></td>
		<td class="acreage"><?=$item->acreage;?></td>
		<td class="address"><?=$item->address;?></td>
        <td class="text-center"><img src="<?php echo base_url().'files/service/thumb/'.$item->thumb;?>" alt="img" height="45" width="60"></td>	
