    ...
    <div class="portlet box blue">
        ...
        <div class="portlet-body">
			...
			<div class="row mtop10"> 
				<div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label col-md-4">Địa chỉ bản đồ</label>
                        <div class="col-md-8">
                              <input type="text" name="maps_address" id="maps_address" value="<?=$finds->maps_address ;?>" class="searchs form-control" />
                        </div>
                    </div>
                </div>  
				<div class="col-md-4">
				...
				<div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="col-md-6" >
                                <span id="show2">
									<img src="<?=base_url();?>files/service/thumb/<?=$finds->thumb; ?>" style="width:60px; height:40px; " />
								</span> 
                            </div>
                        </div>
                    </div>
							...
							<div class="col-md-9" >
								 <div class="row">
									 <span id="show_car_images">
										...
										?>
											<div class="oneimg newimg" name="<?=$v; ?>"><img height="40" width="50" src="<?=base_url();?>files/service/<?=$v; ?>" class="imgupload" /><div class="rmoneimg"><i class="fa fa-times" aria-hidden="true"></i></div></div>
										<?php }?>
									 </span> 
								 </div>
							</div>
...
<script>
    ...
    $(function() {
		...
		/*$('#servicetypeid').multipleSelect({
        	filter: true,
            placeholder:"Chọn  loại sản phẩm",
            single:true
        });*/
		var servicetypeid = '<?=$finds->servicetypeid;?>';
		$('#servicetypeid').multipleSelect('setSelects',[servicetypeid]);
		addform();
    ...
    function save(func, id, type) {
        ...
        $.ajax({
            ...
            success: function(datas) {
				...
				if(type != ''){
					window.location = "<?=admin_url();?>service";
				}
            },
            error: function() {
				$('.loading').hide();
