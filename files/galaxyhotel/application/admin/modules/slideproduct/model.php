<?php
 class SlideproductModel extends CI_Model{
	...
	function saves($array){
		 $check = $this->model->table('galaxy_slide_product')
		 ->select('id')
		 ->where('isdelete',0)
		 ...
		 $result = $this->model
						->table('galaxy_slide_product')
						->insert($array);	
		 return $result;
	}
	function edits($array,$id){
		 $result = $this->model->table('galaxy_slide_product')->save($id,$array);	
		 return $result;
	}
