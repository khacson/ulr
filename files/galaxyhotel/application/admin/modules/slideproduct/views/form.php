    ...
    <div class="portlet box blue">
        ...
        <div class="portlet-body">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label col-md-5">Link (<span class="red">*</span>)</label>
                        <div class="col-md-7">
                            <input type="text" name="url" id="url" class="searchs form-control" value="<?=$url?>"/>
                        </div>
                    </div>
                </div>
...
<script>
        ...
        $.ajax({
            ...
            success: function(datas) {
                ...
                if (obj.status == 0) {
                    ...
                    CKEDITOR.instances['description'].setData("");
                    location.href = '<?=base_url()."admin.php/slideproduct"?>';
                }
            },
            error: function() {
	...
	function addform(){		
	    var img = '<?= base_url() ?>files/slideproduct/' + '<?=$img?>';
