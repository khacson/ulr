<?php
 class PostsModel extends CI_Model{
	...
	function blogType(){
		$query = $this->model->table('galaxy_posts_type')
	...
	function saves($array){
		 $check = $this->model->table('galaxy_posts')
		 ->select('id')
		 ->where('isdelete',0)
	...
	function edits($array,$id){
		 ...
		 $result = $this->model->table('galaxy_posts')->save($id,$array);	
		 return $result;
	}
