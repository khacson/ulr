<?php
 class ProducttypeModel extends CI_Model{
	...
	function getNone(){
		...
		WHERE table_name='galaxy_producttype'; 
		";
		$query = $this->model->query($sql)->execute();
		$obj = new stdClass();
	...
	function saves($array){
		 $result = $this->model->table('galaxy_producttype')
						->insert($array);	
		 return $result;
	}
	function edits($array,$id){
		 $result = $this->model->table('galaxy_producttype')->save($id,$array);	
		 return $result;
	}
