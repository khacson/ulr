            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="form-group">
                        <label class="control-label col-md-3">Loại web (<span class="red">*</span>)</label>
                        <div class="col-md-9">
                            <input type="text" name="webtype_name" id="webtype_name" class="searchs form-control" />
                        </div>
                    </div>
                </div>
				<div class="col-md-4">
...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption" style="margin-top:4px;">
            <i>Có <span class='viewtotal'>0</span> loại web</i>
        </div>
        <div class="tools">
                    ...
                    <div id="tHeader">    	
                        <table id="tbheader" width="100%" cellspacing="0" border="1" >
                            ...
                            <tr>
                                ...
                                <th>STT</th>
                                <th id="ord_webtype_name">Loại web</th>
                                <th>Hình ảnh</th>
...
<script>
    ...
    $(function() {
        ...
        $('#edit').click(function() {
            var id = $('#id').val();
            if (id == '') {
                warning('Vui lòng chọn loại web để sửa');
                return false;
            }
            save('edit', id);
        });
    ...
    function save(func, id) {
        ...
        if (obj.webtype_name == '') {
            error("Loại web <?= getLanguage('all', 'empty') ?>");
            return false;
        }
        $('.loading').show();
    ...
    function funcList(obj) {
        $('.edit').each(function(e) {
            $(this).click(function() {
                var webtype_name = $('.webtype_name').eq(e).html().trim();
                var id = $(this).attr('id');
				var parentid = $(this).attr('parentid');
                $('#id').val(id);
                $('#webtype_name').val(webtype_name);
