 ...
 * @copyright 2015
 */
class Webtype extends CI_Controller {
    ...
    function save() {
        ...
        $login = $this->login;
        $array['friendlyurl'] = $this->admin->friendlyURL($array['webtype_name']);
    ...
    function deletes() {
        ...
        $array['isdelete'] = 1;
        $this->model->table('galaxy_webtype')->where('id',$id)->delete();
    ...
    function isHome(){
		...
		$this->model->table('galaxy_webtype')->save($id,$array);	
	}
	function ordering(){
		$array = array();
		$id = $this->input->post('id');
