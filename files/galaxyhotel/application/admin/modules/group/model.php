 ...
 */
 class GroupModel extends CI_Model{
	...
	function saves($array){
		$check = $this->model->table('galaxy_groups')
					  ->select('id')
					  ->where('isdelete',0)
		...
		$result = $this->model->table('galaxy_groups')->insert($array);	
		return $result;
	}
	function edits($array,$id){
		 ...
		 $result = $this->model->table('galaxy_groups')->save($id,$array);	
		 return $result;
	 }
}