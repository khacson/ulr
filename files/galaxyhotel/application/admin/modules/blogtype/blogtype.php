 ...
 * @copyright 2015
 */
class Blogtype extends CI_Controller {
    ...
    function save() {
        ...
        $login = $this->login;
        $array['friendlyurl'] = $this->admin->friendlyURL($array['blogtype_name']);
    ...
    function deletes() {
        ...
        $array['isdelete'] = 1;
        $this->model->table('galaxy_blog_type')->where('id',$id)->delete();
    ...
    function isHome(){
		...
		$this->model->table('galaxy_blog_type')->save($id,$array);	
	}
	function ordering(){
		$array = array();
		$id = $this->input->post('id');
