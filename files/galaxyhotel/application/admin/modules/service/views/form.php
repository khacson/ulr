    ...
    <div class="portlet box blue">
        ...
        <div class="portlet-body">
			...
			<div class="row mtop10"> 
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label col-md-4">Hình ảnh lớn</label>
                        <div class="col-md-8">
				 ...
				 <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label col-md-4">Hình ảnh nhỏ</label>
                        <div class="col-md-8">
                            <div class="col-md-6" style="padding:0px !important;" >
                                <ul style="margin:0px;" class="button-group">
...
<script>
	...
	function addform(){
	   $("#title").val("<?=$finds->title;?>")
		var img = '<?= base_url() ?>files/service/' + '<?=$finds->image;?>';
		var thumb  = '<?= base_url() ?>files/service/thumb/' + '<?=$finds->thumb;?>';
		var id = '<?=$finds->id;?>';		
		//$('#id').val(id);
