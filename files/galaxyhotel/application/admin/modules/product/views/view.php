            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label col-md-4">Tên phòng</label>
                        <div class="col-md-8">
				...
				<div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label col-md-4">Loại phòng</label>
                        <div class="col-md-8">
...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption"  style="margin-top:4px;">
            <i>Có <span class='viewtotal'>0</span> phòng</i>
        </div>
        <div class="tools">
                    ...
                    <div id="tHeader">    	
                        <table id="tbheader" width="100%" cellspacing="0" border="1" >
                            ...
                            <tr>
								...
								<th id="ord_p.producttypeid">Loại phòng</th>
								<th id="ord_p.price">Giá</th>
								<th id="ord_p.price_type">Loại giá</th>
								<th >Hình ảnh</th> 
...
<script>
    ...
    $(function() {
        ...
        $('#save').click(function() {
            //save('save', '');
			var id = $('#id').val();
            location.href = '<?=base_url()."admin.php/product/form"?>';
        });
        $('#edit').click(function() {
            var id = $('#id').val();
            if (id == '') {
            ...
            //save('edit', id);			
            location.href = '<?=base_url()."admin.php/product/edits/"?>'+id;
        });
    ...
    function refresh() {
        ...
        $('.searchs').val('');
        $('#show').html('');
		$('#producttypeid').multipleSelect('uncheckAll');
