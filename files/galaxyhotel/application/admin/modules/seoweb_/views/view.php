    ...
    <div class="portlet box blue">
        ...
        <div class="portlet-body">
            <div class="row">
				...
				<div class="col-md-4">
					<div class="form-group">
						<label class="control-label col-md-3">Trang </label>
						<div class="col-md-9" >
...
<div class="portlet box blue">
    <div class="portlet-title">
        <div class="caption" style="margin-top:4px;">
            <i>Có <span class='viewtotal'>0</span> seo web</i>
        </div>
        <div class="tools">
...
<script>
    ...
    $(function() {
        ...
        $('#save').click(function() {
            //save('save', '');
			var id = $('#id').val();
            location.href = '<?=base_url()."admin.php/seoweb/form"?>';
        });
        $('#edit').click(function() {
            var id = $('#id').val();
            if (id == '') {
            ...
            //save('edit', id);			
            location.href = '<?=base_url()."admin.php/seoweb/edits/"?>'+id;
        });
