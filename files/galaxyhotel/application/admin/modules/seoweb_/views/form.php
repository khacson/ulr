    ...
    <div class="portlet box blue">
        ...
        <div class="portlet-body">
			...
			<div class="row mtop10"> 
				...
				<div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label col-md-4">Link web</label>
                        <div class="col-md-8">
                            <input type="text" name="link_web" id="link_web" value="<?=$finds->link_web;?>" class="searchs form-control" />
                        </div>
                    </div>
                </div>  
				<div class="col-md-4">
                ...
                <div class="col-md-12">
                        <div class="form-group">
                                ...
                                <div class="col-md-11" style="padding-left:44px !important;">
                                    <textarea class="ckeditor form-control" id="meta_keyword" name="meta_keyword"><?=$finds->meta_keyword;?></textarea>
                                </div>
                        </div>
                </div>
            </div>
            <div class="row mtop10">
                <div class="col-md-12">
                        <div class="form-group">
                                ...
                                <div class="col-md-11" style="padding-left:44px !important;">
                                    <textarea class="ckeditor form-control" id="mete_description" name="mete_description"><?=$finds->mete_description;?></textarea>
                                </div>
                        </div>
                </div>
            </div>
